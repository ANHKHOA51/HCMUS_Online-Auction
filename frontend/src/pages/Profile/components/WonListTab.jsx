                ...
                <div className="won-list">
                    {products.map(product => (
                        <div key={product.id} className="won-item">
                            <div className="won-image" onClick={() => navigate(`/products/${product.id}`)} style={{cursor: 'pointer'}}>
                                <img 
                            ...
                            <div className="won-info">
                                <h4 onClick={() => navigate(`/products/${product.id}`)} style={{cursor: 'pointer'}}>{product.name}</h4>
